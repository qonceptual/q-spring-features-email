package com.qonceptual.spring.email.ses;
...
import com.qonceptual.spring.email.EmailMessagingException;
import com.qonceptual.spring.email.EmailService;
import com.qonceptual.spring.email.EmailValidator;
...
public class SimpleEmailServiceImpl implements EmailService {
    ...
    @Value("${qonceptual.spring.email.ses.accessKey}")
    private String awsAccessKey;

    @Value("${qonceptual.spring.email.ses.secretKey}")
    ...
    @PostConstruct
    private void setup() {
        if(awsAccessKey.equals("${qonceptual.spring.email.ses.accessKey}")
                && awsSecretKey.equals("${qonceptual.spring.email.ses.secretKey}")) {
            LOGGER.warn("You did not configure an AWS accessKey or secretKey for the AWS SES feature.");
        } else {
